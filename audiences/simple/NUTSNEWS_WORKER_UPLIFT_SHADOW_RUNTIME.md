---
title: NutsNews Worker-Uplift Shadow Runtime
wiki:
  source_route: /technical/nutsnews-worker-uplift-shadow-runtime/
  simple_route: /simple/nutsnews-worker-uplift-shadow-runtime/
  primary_diagram:
    file: diagrams/NUTSNEWS_WORKER_UPLIFT_SHADOW_RUNTIME.mmd
    accTitle: "Worker-uplift shadow service pipeline and rollout gates"
    accDescr: "Shows scheduler/fetch/canonicalize/enrichment pipeline, approval and translation shadows, credentials, verification, and rollback for shadow runtime operations."
  status: active
