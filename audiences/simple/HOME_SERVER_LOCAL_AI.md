---
title: Home Server Local AI Provider
wiki:
  source_route: /technical/home-server-local-ai/
  simple_route: /simple/home-server-local-ai/
  primary_diagram:
    file: diagrams/HOME_SERVER_LOCAL_AI.mmd
    accTitle: "Home-server local AI review architecture and fallback"
    accDescr: "Shows the Worker-to-Cloudflare-Tunnel path to localhost Ollama, health/dashboards, deployment controls, and OpenAI fallback behavior."
  status: active
