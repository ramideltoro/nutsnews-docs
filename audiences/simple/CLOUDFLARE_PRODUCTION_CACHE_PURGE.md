---
title: Cloudflare Production Cache Purge
wiki:
  source_route: /technical/cloudflare-production-cache-purge/
  simple_route: /simple/cloudflare-production-cache-purge/
  primary_diagram:
    file: diagrams/CLOUDFLARE_PRODUCTION_CACHE_PURGE.mmd
    accTitle: "Cloudflare cache purge automation"
    accDescr: "A production deployment completion event triggers a controlled purge workflow that calls Cloudflare purge API using purge_everything."
  status: active
