---
title: NutsNews Backend Recovery Workflows
wiki:
  source_route: /technical/nutsnews-backend-recovery/
  simple_route: /simple/nutsnews-backend-recovery/
  primary_diagram:
    file: diagrams/NUTSNEWS_BACKEND_RECOVERY.mmd
    accTitle: "Backend recovery workflow paths"
    accDescr: "Routes recovery actions through fixed actions, protected approvals, and evidence recording."
  status: active
  ...
  approval:
    reviewed_by: pending
    reviewed_on: pending
    technical_source_hash: 135a6271586cfed6acf4316c0a807903b6207de980f43296c880faa885656666
---

# NutsNews Backend Recovery Workflows

This documents the fixed-purpose recovery workflows for
