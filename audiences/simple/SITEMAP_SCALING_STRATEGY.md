---
title: Sitemap Scaling Strategy
wiki:
  source_route: /technical/sitemap-scaling-strategy/
  simple_route: /simple/sitemap-scaling-strategy/
  primary_diagram:
    file: diagrams/SITEMAP_SCALING_STRATEGY.mmd
    accTitle: "Sitemap discovery and scaling path"
    accDescr: "Search bots discover both legacy and scaled sitemap paths; index-based traversal keeps article discovery bounded and cache-safe."
  status: active
