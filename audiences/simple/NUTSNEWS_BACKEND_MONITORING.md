---
title: NutsNews Backend Monitoring Baseline
wiki:
  source_route: /technical/nutsnews-backend-monitoring/
  simple_route: /simple/nutsnews-backend-monitoring/
  primary_diagram:
    file: diagrams/NUTSNEWS_BACKEND_MONITORING.mmd
    accTitle: "Backend monitoring baseline"
    accDescr: "Defines baseline host observability, log retention, and health checks for the backend service stack."
  status: active
