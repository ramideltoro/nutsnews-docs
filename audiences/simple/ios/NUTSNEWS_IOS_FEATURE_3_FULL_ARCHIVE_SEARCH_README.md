---
title: "NutsNews iOS Feature 3 — Full Archive Search"
wiki:
  source_route: /technical/ios/nutsnews-ios-feature-3-full-archive-search-readme/
  simple_route: /simple/ios/nutsnews-ios-feature-3-full-archive-search-readme/
  primary_diagram:
    file: diagrams/ios/NUTSNEWS_IOS_FEATURE_3_FULL_ARCHIVE_SEARCH_README.mmd
    accTitle: "Full archive search behavior"
    accDescr: "The app issues /api/search to fetch archive results, then renders and caches them in native search and saved-story flows."
  status: active
