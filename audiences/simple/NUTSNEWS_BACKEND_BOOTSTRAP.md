---
title: NutsNews Backend Bootstrap
wiki:
  source_route: /technical/nutsnews-backend-bootstrap/
  simple_route: /simple/nutsnews-backend-bootstrap/
  primary_diagram:
    file: diagrams/NUTSNEWS_BACKEND_BOOTSTRAP.mmd
    accTitle: "Backend bootstrap and baseline sequence"
    accDescr: "Initial VPS bootstrap flow installs prerequisites, creates the app host path, and prepares backend services for configuration."
  status: active
  ...
  approval:
    ...
    technical_source_hash: 74ae0f85052338f7426af1ea6b47a4c19ae1797069163363488791c3d5ebc1a0
---
