...
wiki:
  source_route: /technical/deployment-checklist/
  simple_route: /simple/deployment-checklist/
  primary_diagram:
    file: diagrams/DEPLOYMENT_CHECKLIST.mmd
    accTitle: "Deployment safety gate sequence"
    accDescr: "A pre-deploy review, workflow checks, platform deployment handoff, cache purge, and verification loop."
  status: active
