...
wiki:
  source_route: /technical/admin-responsive-dashboards/
  simple_route: /simple/admin-responsive-dashboards/
  primary_diagram:
    file: diagrams/ADMIN_RESPONSIVE_DASHBOARDS.mmd
    accTitle: "Admin responsive dashboard layout flow"
    accDescr: "Protected admin routes are wrapped in a shared responsive shell, then targeted CSS rules and table scrolling rules keep mobile layouts stable without changing desktop behavior."
  status: active
