---
title: NutsNews Worker-Uplift RabbitMQ Recovery
wiki:
  source_route: /technical/nutsnews-worker-uplift-rabbitmq-recovery/
  simple_route: /simple/nutsnews-worker-uplift-rabbitmq-recovery/
  primary_diagram:
    file: diagrams/NUTSNEWS_WORKER_UPLIFT_RABBITMQ_RECOVERY.mmd
    accTitle: "Recovery export paths and drill workflows"
    accDescr: "Shows definition export, clean rebuild drills, stopped-volume restore drills, and health report signals for worker-uplift RabbitMQ recovery and upgrade evidence."
  status: active
  ...
  approval:
    ...
    technical_source_hash: 2f1a1c568e87b35cc08448ad85ad3503adc28dd6bbbb25cddec25e6f984b3dd0
---
