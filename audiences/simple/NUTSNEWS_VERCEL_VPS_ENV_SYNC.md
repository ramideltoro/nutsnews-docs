---
title: Vercel-to-VPS environment synchronization
wiki:
...
app environment. See [Dual-Target Web Deployment](NUTSNEWS_DUAL_TARGET_WEB_DEPLOYMENT.md#immutable-image-and-runtime-public-configuration)
