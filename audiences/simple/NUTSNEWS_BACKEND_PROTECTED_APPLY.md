---
title: NutsNews Backend Protected Apply
wiki:
  source_route: /technical/nutsnews-backend-protected-apply/
  simple_route: /simple/nutsnews-backend-protected-apply/
  primary_diagram:
    file: diagrams/NUTSNEWS_BACKEND_PROTECTED_APPLY.mmd
    accTitle: "Protected apply workflow"
    accDescr: "Protected apply gates backend mutations through review gates, approvals, and drift/guard checks."
  status: active
  ...
  approval:
    reviewed_by: pending
    reviewed_on: pending
    technical_source_hash: 4bdff23f1c6960dc38063076480c7d9622ad1ac5f1a392317f3022831439c5de
---
