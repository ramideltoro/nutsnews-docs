---
title: NutsNews Protected Ansible Apply Workflow
wiki:
  source_route: /technical/nutsnews-protected-ansible-apply/
  simple_route: /simple/nutsnews-protected-ansible-apply/
  primary_diagram:
    file: diagrams/NUTSNEWS_PROTECTED_ANSIBLE_APPLY.mmd
    accTitle: "Protected apply workflow with check and approval gates"
    accDescr: "Shows workflow dispatch to protected environments, check/apply flow, and verification gates."
  status: active
