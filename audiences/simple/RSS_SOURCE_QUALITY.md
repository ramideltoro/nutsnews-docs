---
title: RSS Source Quality Scoring
wiki:
  source_route: /technical/rss-source-quality/
  simple_route: /simple/rss-source-quality/
  primary_diagram:
    file: diagrams/RSS_SOURCE_QUALITY.mmd
    accTitle: "RSS quality and trust-tier flow"
    accDescr: "Active feeds require trusted publisher signals and Google News stays discovery-only, while admin trust/allowlist controls gate what can be selected for publication."
  status: active
