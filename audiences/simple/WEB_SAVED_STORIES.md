---
title: Web Saved Stories
wiki:
  source_route: /technical/web-saved-stories/
  simple_route: /simple/web-saved-stories/
  primary_diagram:
    file: diagrams/WEB_SAVED_STORIES.mmd
    accTitle: "Saved stories client-side flow"
    accDescr: "Story cards are saved in browser localStorage and rendered from local state on the /saved page with no server round-trip."
  status: active
