---
title: NutsNews Worker-Uplift RabbitMQ Provisioning
wiki:
  source_route: /technical/nutsnews-worker-uplift-rabbitmq-provisioning/
  simple_route: /simple/nutsnews-worker-uplift-rabbitmq-provisioning/
  primary_diagram:
    file: diagrams/NUTSNEWS_WORKER_UPLIFT_RABBITMQ_PROVISIONING.mmd
    accTitle: "RabbitMQ provisioning, topology, and recovery evidence"
    accDescr: "Shows protected provisioning path, route-scoped identities and topology bootstrap, persistence/network verification, and rollback/recovery artifacts for worker-uplift RabbitMQ."
  status: active
  ...
  approval:
    ...
    technical_source_hash: c13d5ffb8d49bf6f20b7180fc4921865e1918ffcd0f68f790163b716b2cd2ead
---
...
the timer. Canary JSON reports live under `/var/lib/nutsnews/rabbitmq-probes`,
and canary Prometheus textfile metrics live at
