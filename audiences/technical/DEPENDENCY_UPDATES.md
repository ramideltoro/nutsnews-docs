---
title: Dependency Update Routine
wiki:
  source_route: /technical/dependency-updates/
  simple_route: /simple/dependency-updates/
  primary_diagram:
    file: diagrams/DEPENDENCY_UPDATES.mmd
    accTitle: "Dependency update routine across web, worker, and controller"
    accDescr: "Shows check and update flows for npm dependencies, validation gates by area, report outputs, and post-deploy verification."
  status: active
