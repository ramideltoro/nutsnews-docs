...
wiki:
  source_route: /technical/image-delivery/
  simple_route: /simple/image-delivery/
  primary_diagram:
    file: diagrams/IMAGE_DELIVERY.mmd
    accTitle: "Image pipeline and cache flow"
    accDescr: "Reader pages request optimized image variants through Next.js image delivery with responsive sizes and cache behavior."
  status: active
