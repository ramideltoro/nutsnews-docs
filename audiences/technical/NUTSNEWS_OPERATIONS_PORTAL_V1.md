---
title: NutsNews Operations Portal v1
wiki:
  source_route: /technical/nutsnews-operations-portal-v1/
  simple_route: /simple/nutsnews-operations-portal-v1/
  primary_diagram:
    file: diagrams/NUTSNEWS_OPERATIONS_PORTAL_V1.mmd
    accTitle: "Operations portal deployment and visibility flow"
    accDescr: "Shows the v1 read-only status loop from collector to portal and protected workflows for report/backup operations."
  status: active
  ...
  approval:
    reviewed_by: pending
    reviewed_on: pending
    technical_source_hash: c7e1dfb84d66c680b71701327316f675178e7487b02f73ccb16f74c6bc2aacbd
---
