---
title: Worker GitHub Actions Pipeline
wiki:
  source_route: /technical/worker-github-actions-pipeline/
  simple_route: /simple/worker-github-actions-pipeline/
  primary_diagram:
    file: diagrams/WORKER_GITHUB_ACTIONS_PIPELINE.mmd
    accTitle: "Guarded Worker pipeline and deploy workflow"
    accDescr: "Shows pull-request checks, immutable guard enforcement, required secrets, merge-to-main deploy behavior, and manual workflow dispatch flow."
  status: active
