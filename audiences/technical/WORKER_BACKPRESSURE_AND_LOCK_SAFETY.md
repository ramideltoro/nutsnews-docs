---
title: Worker Backpressure and Lock Safety
wiki:
  source_route: /technical/worker-backpressure-and-lock-safety/
  simple_route: /simple/worker-backpressure-and-lock-safety/
  primary_diagram:
    file: diagrams/WORKER_BACKPRESSURE_AND_LOCK_SAFETY.mmd
    accTitle: "Backpressure and lock-safety guard flow"
    accDescr: "Shows queue and DB pressure checkpoints, lock acquisition/extension, deferred work path, and reporting signals for the Worker ingestion guardrails." 
  status: active
