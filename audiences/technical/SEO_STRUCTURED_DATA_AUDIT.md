---
title: NutsNews SEO Structured Data Audit
wiki:
  source_route: /technical/seo-structured-data-audit/
  simple_route: /simple/seo-structured-data-audit/
  primary_diagram:
    file: diagrams/SEO_STRUCTURED_DATA_AUDIT.mmd
    accTitle: "SEO audit coverage and verification flow"
    accDescr: "The audit validates key metadata and JSON-LD fields across homepage, article pages, and sitemap-derived article URLs before pushing reports to Actions artifacts."
  status: active
