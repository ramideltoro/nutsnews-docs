...
wiki:
  source_route: /technical/runtime-feature-flags/
  simple_route: /simple/runtime-feature-flags/
  primary_diagram:
    file: diagrams/RUNTIME_FEATURE_FLAGS.mmd
    accTitle: "Runtime feature flag control plane"
    accDescr: "Shows flag evaluation paths, rollout controls, and fallback behavior for runtime feature gates."
  status: active
