---
title: Home Server Admin Dashboard
wiki:
  source_route: /technical/home-server-dashboard/
  simple_route: /simple/home-server-dashboard/
  primary_diagram:
    file: diagrams/HOME_SERVER_DASHBOARD.mmd
    accTitle: "Home server dashboard and stats flow"
    accDescr: "Protected admin access loads server stats via a server-side fetch to /admin/home-server and displays runtime health and model/service telemetry."
  status: active
