---
title: NutsNews Supabase Standby Restricted Probe
wiki:
  source_route: /technical/nutsnews-supabase-standby-probe/
  simple_route: /simple/nutsnews-supabase-standby-probe/
  primary_diagram:
    file: diagrams/NUTSNEWS_SUPABASE_STANDBY_PROBE.mmd
    accTitle: "Restricted backend probe readiness boundary"
    accDescr: "Shows app readiness workflow passing a protected DB URL through a forced-command SSH probe on backend host to validate standby credentials and direct connectivity."
  status: active
