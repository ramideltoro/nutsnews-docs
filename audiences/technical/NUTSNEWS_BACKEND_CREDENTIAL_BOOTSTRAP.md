---
title: NutsNews Backend Credential Bootstrap
wiki:
  source_route: /technical/nutsnews-backend-credential-bootstrap/
  simple_route: /simple/nutsnews-backend-credential-bootstrap/
  primary_diagram:
    file: diagrams/NUTSNEWS_BACKEND_CREDENTIAL_BOOTSTRAP.mmd
    accTitle: "Backend credential bootstrap flow"
    accDescr: "Protected workflow prepares GitHub environment and encrypted secrets required for backend automation."
  status: active
  ...
  approval:
    reviewed_by: pending
    reviewed_on: pending
    technical_source_hash: feb4922c49bb634989b6a7ef9f88b37edcb9c38ea42a154a52c2f079fd9dc395
---
