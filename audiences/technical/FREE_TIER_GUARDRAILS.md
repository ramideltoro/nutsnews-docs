---
title: NutsNews Free-Tier Guardrails
wiki:
  source_route: /technical/free-tier-guardrails/
  simple_route: /simple/free-tier-guardrails/
  primary_diagram:
    file: diagrams/FREE_TIER_GUARDRAILS.mmd
    accTitle: "Free-tier cost and quota governance flow"
    accDescr: "A deployment and operations feedback loop maps service usage and billing signals into the guardrail dashboard and operational alerts."
  status: active
