---
title: NutsNews Worker-Uplift RabbitMQ Metrics
wiki:
  source_route: /technical/nutsnews-worker-uplift-rabbitmq-metrics/
  simple_route: /simple/nutsnews-worker-uplift-rabbitmq-metrics/
  primary_diagram:
    file: diagrams/NUTSNEWS_WORKER_UPLIFT_RABBITMQ_METRICS.mmd
    accTitle: "RabbitMQ metric boundaries and admin projection"
    accDescr: "Shows backend Alloy telemetry collection, private listener flow, bounded queue metrics, admin read model projection, and alert/SLO evidence path."
  status: active
  ...
  approval:
    reviewed_by: pending
    reviewed_on: pending
    technical_source_hash: c51427a15765fe0c9ebdfe9e14fe8be253d3094d9128b4a58541d35066dc76ef
---
