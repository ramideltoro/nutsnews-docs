...
wiki:
  ...
  primary_diagram:
    file: diagrams/TROUBLESHOOTING.mmd
    accTitle: "Troubleshooting and recovery flow"
    accDescr: "A recovery flow for deployment, build, cache, worker, database, and logging incidents in NutsNews."
  status: active
  ...
  approval:
    reviewed_by: pending
    reviewed_on: pending
    technical_source_hash: c1c3bd73facc9e93917cbec1df386bdfe1273fcb1e0dbe7f8e905c9e891911b3
---
