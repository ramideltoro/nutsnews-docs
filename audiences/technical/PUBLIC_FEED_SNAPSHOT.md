---
title: Public Feed Snapshot and Edge Fallback
wiki:
  source_route: /technical/public-feed-snapshot/
  simple_route: /simple/public-feed-snapshot/
  primary_diagram:
    file: diagrams/PUBLIC_FEED_SNAPSHOT.mmd
    accTitle: "Public feed snapshot publishing path"
    accDescr: "Shows scheduled feed snapshot export, integrity checks, and Cloudflare edge fallback flow."
  status: active
