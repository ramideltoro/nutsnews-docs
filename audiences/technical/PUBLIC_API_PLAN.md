---
title: Public API Plan
wiki:
  source_route: /technical/public-api-plan/
  simple_route: /simple/public-api-plan/
  primary_diagram:
    file: diagrams/PUBLIC_API_PLAN.mmd
    accTitle: "Public API platform rollout plan"
    accDescr: "Shows API planning phases, contract discipline, and phased rollout/rollup points."
  status: active
