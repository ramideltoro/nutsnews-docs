...
wiki:
  ...
  primary_diagram:
    file: diagrams/ADMIN_ARTICLE_REVIEWS.mmd
    accTitle: "Admin article review dashboard workflow"
    accDescr: "A workflow for reviewing accepted and rejected articles with version-aware AI decision dashboards."
  status: active
