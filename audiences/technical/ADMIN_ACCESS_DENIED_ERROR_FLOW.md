...
wiki:
  ...
  primary_diagram:
    file: diagrams/ADMIN_ACCESS_DENIED_ERROR_FLOW.mmd
    accTitle: "Admin access-denied flow"
    accDescr: "Auth.js error handling path from provider auth failure to access-denied page and admin login recovery flow."
  status: active
