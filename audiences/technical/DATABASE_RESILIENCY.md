---
title: NutsNews Database Resiliency
wiki:
  source_route: /technical/database-resiliency/
  simple_route: /simple/database-resiliency/
  primary_diagram:
    file: diagrams/DATABASE_RESILIENCY.mmd
    accTitle: "Database resiliency and failover readiness"
    accDescr: "Shows the primary PostgreSQL source database, one-way relay to Supabase standby, synchronization states, failover safety gates, and backup-recovery layers."
  status: active
