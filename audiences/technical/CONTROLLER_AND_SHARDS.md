---
title: Controller and Shard Operations
wiki:
  source_route: /technical/controller-and-shards/
  simple_route: /simple/controller-and-shards/
  primary_diagram:
    file: diagrams/CONTROLLER_AND_SHARDS.mmd
    accTitle: "Controller-driven shard routing and run-state validation"
    accDescr: "Shows automatic and manual shard dispatch through the controller, direct shard endpoints, log pipelines, and health-check queries after manual runs."
  status: active
