---
title: NutsNews Backend Service Baseline
wiki:
  source_route: /technical/nutsnews-backend-service-baseline/
  simple_route: /simple/nutsnews-backend-service-baseline/
  primary_diagram:
    file: diagrams/NUTSNEWS_BACKEND_SERVICE_BASELINE.mmd
    accTitle: "Backend service baseline attestation"
    accDescr: "Captures read-only attestation, service decision checks, and re-attestation triggers."
  status: active
  ...
  approval:
    reviewed_by: pending
    reviewed_on: pending
    technical_source_hash: 9020cb9ee747f91d8e96f8f84f23a11ac028839eeb296dfd2ed4f12bc18620b3
---
