---
title: Oracle Local AI Provider
wiki:
  source_route: /technical/oracle-local-ai/
  simple_route: /simple/oracle-local-ai/
  primary_diagram:
    file: diagrams/ORACLE_LOCAL_AI.mmd
    accTitle: "Oracle VM local AI rollout and fallback flow"
    accDescr: "Shows the optional Oracle Free Tier local AI architecture, deployment and service setup steps, worker deployment sequence, and rollback to OpenAI."
  status: active
