...
reusable workflow uses a tag, branch, or other mutable ref. Local actions remain
allowed because they are reviewed inside the repository.
...
they end in a full commit SHA or a Docker digest.
