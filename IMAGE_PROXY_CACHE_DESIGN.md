---
title: Secure Image Proxy/Cache Design
wiki:
  source_route: /technical/image-proxy-cache-design/
  simple_route: /simple/image-proxy-cache-design/
  primary_diagram:
    file: diagrams/IMAGE_PROXY_CACHE_DESIGN.mmd
    accTitle: "Secure image proxy/cache architecture"
    accDescr: "Current Next.js image path and proposed optional Cloudflare image proxy/cache design with allowlist, proxy gating, and cache-write sequencing."
  status: active
