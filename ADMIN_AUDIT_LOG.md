...
wiki:
  ...
  primary_diagram:
    file: diagrams/ADMIN_AUDIT_LOG.mmd
    accTitle: "Admin audit log mutation flow"
    accDescr: "A protected-server workflow showing who called an admin action, what changed, and how DB transaction boundaries preserve audit integrity."
  status: active
